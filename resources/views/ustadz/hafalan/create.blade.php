    ...
    <div class="col-lg-8">
        ...
        <div class="page-header">
            <div>
                ...
                <div class="page-header-sub">Input setoran, wisuda, zaidah, atau ujian hafalan santri</div>
            </div>
        ...
        <form method="POST" action="{{ route('ustadz.hafalan.store') }}" id="formHafalan">
            @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group-custom">
                                ...
                                <select name="kategori" id="kategoriSelect" class="form-control-custom">
                                    <option value="" {{ old('kategori') == '' ? 'selected' : '' }}>— Tanpa Kategori —</option>
                                    <option value="wisuda" {{ old('kategori') === 'wisuda' ? 'selected' : '' }}> Wisuda</option>
                                    <option value="zaidah" {{ old('kategori') === 'zaidah' ? 'selected' : '' }}> Zaidah</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group-custom">
                                ...
                                <select name="jenis" class="form-control-custom" required>
                                    <option value="setoran_baru" {{ old('jenis','setoran_baru') === 'setoran_baru' ? 'selected' : '' }}>Setoran Baru</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group-custom">
                                ...
                                <input type="number" name="ayat_dari" class="form-control-custom"
                                    value="{{ old('ayat_dari') }}" placeholder="Opsional" min="1">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group-custom">
                                ...
                                <input type="number" name="ayat_sampai" class="form-control-custom"
                                    value="{{ old('ayat_sampai') }}" placeholder="Opsional" min="1">
                            ...
                            <div class="form-group-custom">
                                ...
                                <select name="target_wisuda" class="form-control-custom">
                                    ...
                                    @foreach(['Paket Juz 30','5 Juz','10 Juz','15 Juz','20 Juz','30 Juz (Khatam)'] as $tw)
                                        <option value="{{ $tw }}" {{ old('target_wisuda') === $tw ? 'selected' : '' }}>{{ $tw }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group-custom">
                                ...
                                <select name="sesi_wisuda" class="form-control-custom">
                                    ...
                                    <option value="setoran_bertahap" {{ old('sesi_wisuda') === 'setoran_bertahap' ? 'selected' : '' }}>Setoran Bertahap</option>
                                    <option value="tasmi" {{ old('sesi_wisuda') === 'tasmi' ? 'selected' : '' }}>Tasmi'</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group-custom">
                                ...
                                <select name="status_wisuda" class="form-control-custom">
                                    ...
                                    <option value="lulus" {{ old('status_wisuda') === 'lulus' ? 'selected' : '' }}>✅ Lulus</option>
                                    <option value="perbaikan" {{ old('status_wisuda') === 'perbaikan' ? 'selected' : '' }}>⚠️ Perbaikan</option>
                                    <option value="belum_lulus" {{ old('status_wisuda') === 'belum_lulus' ? 'selected' : '' }}>❌ Belum Lulus</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group-custom">
                                ...
                                <textarea name="catatan_perbaikan" class="form-control-custom" rows="2"
                                    placeholder="Catatan jika ada perbaikan...">{{ old('catatan_perbaikan') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group-custom">
                                ...
                                <input type="number" name="zaidah_ke" class="form-control-custom"
                                    value="{{ old('zaidah_ke') }}" placeholder="cth: 1" min="1">
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group-custom">
                                ...
                                <textarea name="keterangan_zaidah" class="form-control-custom" rows="2"
                                    placeholder="Tambahan di luar target wisuda">{{ old('keterangan_zaidah', 'Tambahan di luar target wisuda') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group-custom">
                                ...
                                <select name="jenis_ujian" class="form-control-custom">
                                    ...
                                    <option value="pekanan" {{ old('jenis_ujian') === 'pekanan' ? 'selected' : '' }}>Pekanan</option>
                                    <option value="bulanan" {{ old('jenis_ujian') === 'bulanan' ? 'selected' : '' }}>Bulanan</option>
                                    <option value="tengah_semester" {{ old('jenis_ujian') === 'tengah_semester' ? 'selected' : '' }}>Tengah Semester</option>
                                    <option value="semester" {{ old('jenis_ujian') === 'semester' ? 'selected' : '' }}>Semester</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group-custom">
                                ...
                                <select name="model_ujian" class="form-control-custom">
                                    <option value="">-- Pilih --</option>
                                    <option value="tasmi" {{ old('model_ujian') === 'tasmi' ? 'selected' : '' }}>Tasmi'</option>
                                    <option value="sambung_ayat" {{ old('model_ujian') === 'sambung_ayat' ? 'selected' : '' }}>Sambung Ayat</option>
                                    <option value="acak_halaman" {{ old('model_ujian') === 'acak_halaman' ? 'selected' : '' }}>Acak Halaman</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group-custom">
                                ...
                                <select name="status_ujian" id="statusUjianSelect" class="form-control-custom">
                                    <option value="">-- Pilih --</option>
                                    <option value="lulus" {{ old('status_ujian') === 'lulus' ? 'selected' : '' }}>✅ Lulus</option>
                                    <option value="remedial" {{ old('status_ujian') === 'remedial' ? 'selected' : '' }}>🔄 Remedial</option>
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="form-group-custom">
                                ...
                                <input type="number" name="salah_ringan" class="form-control-custom"
                                    value="{{ old('salah_ringan') }}" placeholder="0" min="0">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group-custom">
                                ...
                                <input type="number" name="salah_berat" class="form-control-custom"
                                    value="{{ old('salah_berat') }}" placeholder="0" min="0">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group-custom">
                                ...
                                <select name="kelancaran" class="form-control-custom">
                                    <option value="">-</option>
                                    @for($i = 1; $i <= 5; $i++)
                                        <option value="{{ $i }}" {{ old('kelancaran') == $i ? 'selected' : '' }}>{{ $i }}</option>
                                    @endfor
                                </select>
                        ...
                        <div class="col-md-2">
                            <div class="form-group-custom">
                                ...
                                <select name="tajwid_makhraj" class="form-control-custom">
                                    <option value="">-</option>
                                    @for($i = 1; $i <= 5; $i++)
                                        <option value="{{ $i }}" {{ old('tajwid_makhraj') == $i ? 'selected' : '' }}>{{ $i }}</option>
                                    @endfor
                                </select>
                                <div style="font-size:9px;color:var(--txt3);margin-top:2px;">Skala 1-5</div>
                            </div>
            ...
            <div class="d-flex gap-3 justify-content-end flex-wrap">
                ...
                <button type="submit" name="simpan_dan_tambah_lagi" value="1" class="btn-outline-hijau" style="border-color:var(--emas-dark);color:var(--emas-dark);">
...
toggleKategori(); // init on load (for old() values)
